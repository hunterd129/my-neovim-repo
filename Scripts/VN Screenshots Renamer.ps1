...
$TargetDir = "C:\Users\hunte\Pictures\Visual Novels\VN Screenshots"
...
# Determine padding (if > 999 files, use 4 digits; otherwise use 3)
$Padding = if ($TotalFiles -gt 999) { 4 } else { 3 }
